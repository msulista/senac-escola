            ...
            <div class="span10">
              ...
              <div class="hero-unit">
                ...
                <h2>Mostra Aluno Cadastrado:</h2>                
              	<br>               	                
                        <h3>Deletando dados do Aluno:</h3>
                        <br>
                        <dl class="dl-horizontal">
                           
                               <dt>Matricula:</dt> 	<dd><?PHP echo($matri)?></dd>             		
                               <dt>Nome:</dt>		<dd><?PHP echo($nome)?></dd>
                               <dt>E-Email:</dt>	<dd><?PHP echo($email)?></dd>
                               <dt>Curso:</dt>		<dd><?PHP echo($curso)?></dd>
                            <form action="confirmDelAluno.php" method="post">
                            						<input type="hidden" name="matri_del" value="<?PHP echo($matri)?>">   
